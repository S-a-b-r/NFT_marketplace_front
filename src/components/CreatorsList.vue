...
props.creators.forEach(creator => creator.class = getVisibleClass(creator.id))
...
<template>
    <div class="grid grid-cols-1 grid-rows-5 gap-5 md:grid-cols-2 md:grid-rows-3 lg:grid-cols-4 lg:grid-rows-3">
